...
public class SectionFragment extends Fragment implements Response.Listener<JSONObject>,Response.ErrorListener  {
    ...
    private void Iniciar_sesion(){
        ...
        if (correo.isEmpty() || clave.isEmpty()){
            ...
            String url = "http://172.16.60.24/WebServesRoxy/sesion.php?correo="+correo+"&clave="+clave;
    ...
    public void onResponse(JSONObject response) {
        Toast.makeText(getContext(), "Cargando sesion", Toast.LENGTH_SHORT).show();
